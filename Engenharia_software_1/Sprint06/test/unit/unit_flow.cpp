...
void unit_flow_copy_constructor() { 
    ...
    System* system1 = new SystemHandle("Sys 1", 5.0);
    System* system2 = new SystemHandle("Sys 2", 6.0);
...
void unit_flow_setSource(){
    ...
    System* system = new SystemHandle("Test System");
    Flow* flow1 = new FlowHandle<ExponencialFlow>("Flow 1");
...
void unit_flow_clearSource(){
    ...
    System* system = new SystemHandle("Test System");
    Flow* flow1 = new FlowHandle<ExponencialFlow>("Flow 1",system);
    flow1->clearSource();
