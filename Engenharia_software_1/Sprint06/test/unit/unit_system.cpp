...
void unit_system_sumOperator(){
    System* system1 = new SystemHandle("Population 1", 100.0);
    System* system2 = new SystemHandle("Population 2", 10.0);

    cout << "TEST 10 - System class sum operator" << endl;
    assert(((*system1) + (*system2)) == 110);
    assert(((*system1) + 20.0) == 120);
...
void unit_system_minusOperator(){
    ...
    assert(((*system1) - (*system2)) == 90);
    assert(((*system1) - 20.0) == 80);
...
void unit_system_timesOperator(){
    ...
    assert(((*system1) * (*system2)) == 1000);
    assert(((*system1) * 20.0) == 2000);
...
void unit_system_divisionOperator(){
    ...
    assert(((*system1) / (*system2)) == 10);
    assert(((*system1) / 20.0) == 5);
